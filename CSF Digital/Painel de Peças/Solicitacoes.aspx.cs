...
public partial class Solicitacoes : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dtReqUSD.Text = DateTime.Now.ToString("yyyyMMdd");
    }
    protected void btSolicitar_Click(object sender, EventArgs e)
    {
        ...
        if (partNumber1.Enabled)
        {
            ...
            cadastro = newReq.Cadastrar(newid.ToString());
            ids = newid.ToString();
        ...
        if (cadastro)
        {
            ...
            string emailLista = Util.RetornaEmailUsuario(User.Identity.Name.ToString().ToLower().Trim());
            ...
            if (emailLista != "" && emailLista != null)
            {
                //emailLista += ", logisticasls@csfdigital.com.br";
            }
            else
            {
                //emailLista = "logisticasls@csfdigital.com.br";
            ...
            msg.Enviar(emailLista, assunto, mensagem, "Painel de Peças");
        }
