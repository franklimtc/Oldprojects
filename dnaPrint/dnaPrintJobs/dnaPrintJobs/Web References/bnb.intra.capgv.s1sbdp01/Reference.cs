...
namespace dnaPrintJobs.bnb.intra.capgv.s1sbdp01 {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="printjobSoap", Namespace="http://tempuri.org/")]
    public partial class printjob : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public printjob() {
            this.Url = global::dnaPrintJobs.Properties.Settings.Default.dnaPrintJobs_bnb_intra_capgv_s1sbdp01_printjob;
        ...
        /// <remarks/>
        public void InserirAsync(string value) {
            this.InserirAsync(value, null);
        }
        
        /// <remarks/>
        public void InserirAsync(string value, object userState) {
            ...
            this.InvokeAsync("Inserir", new object[] {
                        value}, this.InserirOperationCompleted, userState);
        }
