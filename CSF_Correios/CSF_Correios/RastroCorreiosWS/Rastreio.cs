...
namespace RastroCorreios
{
    public class Rastreio
    {
        public static returnObjeto RastrearObjeto(string postagem)
        {
            correios.ServiceClient client = new correios.ServiceClient();
            var requestInterceptor = new InspectorBehavior();

            client.Endpoint.Behaviors.Add(requestInterceptor);

            client.buscaEventos("ECT", "SRO", "L", "U", "101", postagem);
