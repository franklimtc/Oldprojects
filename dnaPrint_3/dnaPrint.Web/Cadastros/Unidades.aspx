...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <asp:GridView runat="server" ID="gvUnidades" CssClass="table table-hover table-condensed" DataSourceID="DSObjUnidades" AutoGenerateColumns="False" OnRowCommand="gvUnidades_RowCommand">
                <Columns>
                     <asp:TemplateField>
                         <ItemTemplate>
