...
namespace dnaPrint.Base
{
    public class Suprimentos
    {
        ...
        public static List<Suprimentos> Listar(string connString, Operacoes.tipo Tipo)
        {
            ...
            string tsql = "select idEquipamento, uf, cidade, unidade, setor, fila, serie, ip, toner_pr, toner_ma, toner_am, toner_ci, cilindro, data from vw_suprimentos";
