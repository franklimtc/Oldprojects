...
namespace WebEmailMonitor
{
    public class Email
    {
        ...
        public static List<Email> ListarEmailsPendentes()
        {
            ...
            //dtEmails = Dao.SQLRetornaDT("select * from Emails where emailEnviado = 0 or emailEnviado is null;");
            dtEmails = Dao.RetornaDT("select * from Emails where emailEnviado = 0 or emailEnviado is null;");
